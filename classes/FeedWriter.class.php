...
class FeedWriter
{
	...
	*/
	private function printHead()
	{
		...
		{
			$out .= '<rss version="2.0" xmlns:media="http://search.yahoo.com/mrss/" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:geo="http://www.w3.org/2003/01/geo/wgs84_pos#" xmlns:georss="http://www.georss.org/georss">';
		}
	...
	private function printChannels()
	{
		...
		foreach ($this->channels as $key => $value)
		{
			if($this->version == ATOM && $key == 'link')
			{
				...
				//Add the id for ATOM
				$out .= $this->makeNode('id', FeedWriter::uuid($value, 'urn:uuid:'));
			}
			else
			{
